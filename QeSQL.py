...
class QeSQL(QeFont):
    def __init__(self,paramsBD: dict,consultaUnic: str='',consultaLlista: str='', consultaTaula: str=''):
        ...
        if 'Database' not in paramsBD or 'DatabaseName' not in paramsBD:
            raise BaseDadesInvalida('La base de dades passada com a paràmetre no és vàlida',"El diccionari hauria d'incloure com a mínim un element 'Database' i un element 'DatabaseName")
